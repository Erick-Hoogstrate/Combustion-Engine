function [cv_mix_temp] = cv_function(percentage,T)
...
%% Cv for mixtures
M_mix_gas = M_gas + M_air_gas;  % total mass reactants 0% ethanol (100% gasoline) combustion
M_mix_eth = M_eth + M_air_eth;  % total mass reactants 100% ethanol combustion
...
cv_mix_temp = ((1-percentage)*cv_mix_gas + percentage*cv_mix_eth)./1000;
