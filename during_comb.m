function [Cv_during, Cp_during, Rg_during] = during_comb(E, Tr, Xb)
...
%% 
Cv_mix_gas = (1-Xb)*Cv_mix_gas+Xb*Cv_prod_gas;
Cp_mix_gas = (1-Xb)*Cp_mix_gas+Xb*Cp_prod_gas;
Cv_mix_eth = (1-Xb)*Cv_mix_eth+Xb*Cv_prod_eth;
Cp_mix_eth = (1-Xb)*Cp_mix_eth+Xb*Cp_prod_eth;

Cv_during  = ((1-E)*Cv_mix_gas + E*Cv_mix_eth)./1000;   
Cp_during  = ((1-E)*Cp_mix_gas + E*Cp_mix_eth)./1000;   

Rg_during  = (Cp_during-Cv_during)*1000;       